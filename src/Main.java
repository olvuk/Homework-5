public class Main {
    ...
    public static void task1() {
        ...
        // с телефона, ему предлагается скачать приложение с учетом того, какая операционная система
        // у пользователя.
    ...
    public static void task4() {
        ...
        // о том, когда будет доставлена его карта, нужно знать расстояние
    ...
    public static void task5() {
        ...
        // месяца используйте переменную monthNumber = 12.
